...
export default function FunnelVisualizer({
  ...
  const completedCount = funnel?.completed ?? 0;
  const startedCount = (funnel?.started ?? 0) + completedCount;

  const stages = [
    {
      title: '1. Registered Leads',
      description: 'Attended & registered at drive',
      count: totalLeads,
    ...
    },
    {
      ...
      description: 'Initiated 4-step wizard',
      count: startedCount,
    ...
    },
    {
      ...
      description: 'Signed & submitted to committee',
