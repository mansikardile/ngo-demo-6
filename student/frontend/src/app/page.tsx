...
export default function StudentLandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans selection:bg-rose-500 selection:text-white">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-rose-50/30 to-indigo-50/20 border-b border-slate-200/80 pt-16 pb-24 px-4 sm:px-8 w-full">
        <div className="absolute top-10 right-10 w-96 h-96 bg-rose-300/20 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-indigo-300/20 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />

        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <ScrollReveal direction="up" distance={40} duration={1100} className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-50 text-rose-700 text-xs font-extrabold border border-rose-200 shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-rose-500" />
              <span>{t.heroPill}</span>
            </div>

            <h1 className="text-4xl sm:text-6xl font-black text-slate-900 tracking-tight leading-[1.12]">
              <span className="text-rose-600 bg-clip-text text-transparent bg-gradient-to-r from-rose-600 via-pink-600 to-indigo-700">
                {t.heroTitle1}
              </span>{' '}
              {t.heroTitle2}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 pt-2">
              <a
                href="#sessions"
                className="w-full sm:w-auto px-7 py-3.5 bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white font-extrabold text-xs rounded-xl shadow-lg shadow-rose-600/25 transition-all flex items-center justify-center gap-2 hover-lift"
              >
              ...
              <Link
                href="/signup"
                className="w-full sm:w-auto px-6 py-3.5 bg-white hover:bg-slate-50 text-slate-800 font-bold text-xs rounded-xl border border-slate-200/80 shadow-sm transition-all flex items-center justify-center gap-1.5 hover-lift"
              >
                <span>{t.heroBtnScholarship}</span>
              </Link>
            </div>
          </ScrollReveal>

          {/* Right Hero: Authentic Collegiate Female Scholars Collaboration */}
          <ScrollReveal direction="left" distance={45} delay={150} duration={1100} className="lg:col-span-5 relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-white relative group">
              <img
                ...
                alt="Collegiate female engineering scholars collaborating with laptops"
                className="w-full h-80 sm:h-96 object-cover group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/75 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-rose-300">Katalyst India</span>
                <p className="text-sm font-bold leading-tight">4,500+ Young Women Engineering Scholars Supported</p>
              </div>
            </div>

            {/* Floating Metric Badge 1 */}
            <div className="absolute -top-5 -left-4 p-3.5 rounded-2xl glass-card border border-white/90 shadow-xl max-w-[210px] animate-float">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-rose-600 text-white flex items-center justify-center font-black text-xs shrink-0 shadow-md shadow-rose-600/20">
                  100%
                </div>
                <div>
                  <p className="text-[11px] font-black text-slate-900 leading-tight">{t.heroTagFocus}</p>
                  <p className="text-[9px] text-slate-500">{t.heroTagFocusSub}</p>
                </div>
              </div>
            </div>

            {/* Floating Metric Badge 2 */}
            <div className="absolute -bottom-5 -right-4 p-3.5 rounded-2xl glass-card border border-white/90 shadow-xl max-w-[210px] animate-float-delayed">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-black text-xs shrink-0 shadow-md shadow-indigo-600/20">
                  100%
                </div>
                <div>
                  <p className="text-[11px] font-black text-slate-900 leading-tight">{t.heroTagLaptop}</p>
                  <p className="text-[9px] text-slate-500">{t.heroTagLaptopSub}</p>
                </div>
              </div>
            </div>
          </ScrollReveal>
